...
module Holidays
  ...
  module ES # :nodoc:
    def self.defined_regions
      [:es, :es_an, :es_ib, :es_ar, :es_cl, :es_m, :es_cn, :es_cm, :es_mu, :es_lo, :es_ga, :es_ce, :es_o, :es_ex, :es_ct, :es_vc, :es_v]
    end

    def self.holidays_by_month
      {
              0 => [{:function => lambda { |year| Holidays.easter(year)-3 }, :function_id => "easter(year)-3", :name => "Jueves Santo", :regions => [:es]},
